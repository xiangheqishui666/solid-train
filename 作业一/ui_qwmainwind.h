...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        action111 = new QAction(QWMainWind);
        action111->setObjectName("action111");
        action111->setIcon(icon3);
        action111->setMenuRole(QAction::MenuRole::NoRole);
        ...
        mainToolBar->addAction(action111);
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        action111->setText(QCoreApplication::translate("QWMainWind", "\346\230\276\347\244\272\347\252\227\345\217\243", nullptr));
